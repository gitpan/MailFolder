...
okay_if(4, $folder->delete_message(3)); # try to delete an existing one
okay_if(5, (-e "testfolders/emaul_1/3")); # make sure it's still there
okay_if(6, ($folder->sync() == 0));
okay_if(7, !(-e "testfolders/emaul_1/3")); # should be gone now
okay_if(8, (-e "testfolders/emaul_1/1")); # make sure correct one was stomped

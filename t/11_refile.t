...
okay_if(4, (-e "testfolders/emaul_1/1"));
okay_if(5, (-e "testfolders/emaul_1/3"));
okay_if(6, (-e "testfolders/emaul_1/4"));
okay_if(7, ($folder->sync == 0));
okay_if(8, !(-e "testfolders/emaul_1/1"));
okay_if(9, (-e "testfolders/emaul_1/3"));
okay_if(10, (-e "testfolders/emaul_1/4"));
okay_if(11, $folder->dup(3, $folder));
okay_if(12, (-e "testfolders/emaul_1/3"));
okay_if(13, (-e "testfolders/emaul_1/5"));
